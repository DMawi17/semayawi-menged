...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative h-11 w-11 rounded-lg border border-gray-200 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-110 active:scale-95 transition-all duration-200 flex items-center justify-center group cursor-pointer"
