...
/**
 * Get MDX components configuration (server-safe version)
 * This function returns all the MDX component overrides without using React hooks
 */
export function getMDXComponents(customComponents: MDXComponents = {}): MDXComponents {
  return {
    ...
    h2: ({ children }: { children?: ReactNode }) => {
      ...
      return (
        <>
          <h2
            id={id}
            className="mt-16 mb-4 text-3xl font-semibold tracking-tight text-[#575175] dark:text-purple-300"
          >
            {cleanText}
          </h2>
        </>
    ...
    h3: ({ children }: { children?: ReactNode }) => {
      ...
      return (
        <>
          <h3
            id={id}
            className="mt-12 mb-3 text-2xl font-semibold tracking-tight text-[#575175] dark:text-purple-300"
          >
            {cleanText}
          </h3>
        </>
    ...
    ul: ({ children }: { children?: ReactNode }) => (
      <ul className="my-6 space-y-3 text-foreground">{children}</ul>
    ),
    ol: ({ children }: { children?: ReactNode }) => (
      <ol className="my-6 space-y-3 text-foreground">{children}</ol>
    ),
