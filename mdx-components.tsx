...
export function useMDXComponents(components: MDXComponents): MDXComponents {
	return {
		...
		h5: ({ children }: { children?: ReactNode }) => (
			<h5 className="mt-4 mb-2 text-lg font-semibold tracking-tight text-foreground">
				{children}
			</h5>
		),
		h6: ({ children }: { children?: ReactNode }) => (
			<h6 className="mt-4 mb-2 text-base font-semibold tracking-tight text-foreground">
				{children}
			</h6>
		),
